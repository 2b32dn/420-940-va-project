...
async function loadMenu() {
	try {
		const response = await fetch("https://www.morenarestaurant.ca/api/menu/combo");
...
async function loadMainMenu() {
	try {
		const response = await fetch("https://www.morenarestaurant.ca/api/menu/main");
		if (!response.ok) throw new Error("Network response was not ok");
...
async function loadSoupsNoodlesMenu() {
	try {
		const response = await fetch("https://www.morenarestaurant.ca/api/menu/soup&noodles");
		if (!response.ok) throw new Error("Network response was not ok");
...
async function loadSpecialsExtrasMenu() {
	try {
		const response = await fetch("https://www.morenarestaurant.ca/api/menu/specials&extras");
		if (!response.ok) throw new Error("Network response was not ok");
...
async function loadDessertsDrinksMenu() {
	try {
		const response = await fetch("https://www.morenarestaurant.ca/api/menu/desserts&drinks");
		if (!response.ok) throw new Error("Network response was not ok");
